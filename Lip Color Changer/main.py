...
#Create the box around the image and crop the image
...
while True:
    ...
    for face in faces:
        ...
        #imgOriginal = cv2.rectangle(imgOriginla, (x1, y1), (x2, y2), (0, 255, 0), 2)
        ...
        for n in range(68):
            ...
            myPoints.append([x, y])
            # cv2.circle(imgOriginla, (x, y), 5, (50, 50, 255), cv2.FILLED)
